...
#import "LIFriendTableViewController.h"
#import "LIMeTableViewController.h"
#import "LIShopTableViewController.h"
...
- (NSArray *)viewControllers {
    LIEssenceTableView *firstViewController = [[LIEssenceTableView alloc] init];
    UIViewController *firstNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:firstViewController];
    
    LIFriendTableViewController *secondViewController = [[LIFriendTableViewController alloc] init];
    UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    
    LIMeTableViewController *thirdViewController = [[LIMeTableViewController alloc] init];
    UIViewController *thirdNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    LIShopTableViewController *fourthViewController = [[LIShopTableViewController alloc] init];
